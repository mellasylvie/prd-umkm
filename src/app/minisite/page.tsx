              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="about" defaultValue="Menyajikan kopi terbaik dari biji pilihan nusantara. Nikmati senja bersama secangkir kehangatan dari kami." />
                  </div>
                   <div className="space-y-2">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">Rekomendasi ukuran: 200x200px</p>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="banner">Banner Hero</Label>
                    <Input id="banner" type="file" />
                    <p className="text-sm text-muted-foreground">Rekomendasi ukuran: 1200x600px</p>
                  </div>
                  <Button>Simpan Perubahan</Button>
                </CardContent>
              </Card>
            ...
            <TabsContent value="cta">
                 <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Atur tombol yang akan ditampilkan di minisite Anda.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        <div className="flex items-center justify-between">
                            <Label htmlFor="cta-whatsapp" className="flex items-center gap-2"><Phone className="h-5 w-5 text-green-500" /> WhatsApp</Label>
                            <Switch id="cta-whatsapp" defaultChecked />
                        </div>
                        <div className="flex items-center justify-between">
                            <Label htmlFor="cta-instagram" className="flex items-center gap-2"><Instagram className="h-5 w-5 text-pink-500" /> Instagram</Label>
                            <Switch id="cta-instagram" defaultChecked />
                        </div>
                        <div className="flex items-center justify-between">
                            <Label htmlFor="cta-shopee" className="flex items-center gap-2"><ShoppingBag className="h-5 w-5 text-orange-500" /> Shopee/Tokopedia</Label>
                            <Switch id="cta-shopee" />
                        </div>
                        <div className="flex items-center justify-between">
                            <Label htmlFor="cta-website" className="flex items-center gap-2"><Globe className="h-5 w-5 text-blue-500" /> Website</Label>
                ...
                <div className="w-full h-full overflow-y-auto bg-slate-50">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-12 left-1/2 -translate-x-1/2">
                      <Image src={logo} alt="Logo" width={80} height={80} className="rounded-full border-4 border-white bg-white" data-ai-hint="cafe logo"/>
                    </div>
                  </div>
                  
                  <div className="text-center mt-16 px-4">
                    <h1 className="text-xl font-bold font-headline">Kopi Senja</h1>
                  ...
                  <div className="px-4 mt-6 grid grid-cols-2 gap-2">
                    <Button className="bg-green-500 hover:bg-green-600 text-white"><Phone className="w-4 h-4 mr-2"/> WhatsApp</Button>
                    <Button className="bg-pink-500 hover:bg-pink-600 text-white"><Instagram className="w-4 h-4 mr-2"/> Instagram</Button>
                  </div>
                </div>
              </div>
            </CardContent>
